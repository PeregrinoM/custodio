...
const BookVersionHistory = ({ books }: BookVersionHistoryProps) => {
  ...
  const getComparisonTypeBadge = (comp: BookComparison) => {
    if (comp.comparison_type === 'test_import') {
      return (
        <Badge className="bg-purple-100 text-purple-800 border-purple-300 dark:bg-purple-900/60 dark:text-purple-100 dark:border-purple-700 font-medium">
    ...
    if (comp.version_notes?.includes('Línea base cambiada')) {
      return (
        <Badge className="bg-amber-100 text-amber-800 border-amber-300 dark:bg-amber-900/60 dark:text-amber-100 dark:border-amber-700 font-medium animate-pulse">
    ...
    if (comp.comparison_type === 'initial_import') {
      return (
        <Badge className="bg-emerald-100 text-emerald-800 border-emerald-300 dark:bg-emerald-900/60 dark:text-emerald-100 dark:border-emerald-700 font-medium">
    ...
    return (
      <Badge className="bg-blue-100 text-blue-800 border-blue-300 dark:bg-blue-900/60 dark:text-blue-100 dark:border-blue-700 font-medium">
